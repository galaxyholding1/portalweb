          ...
          <div className="tarjetas-recomendadas">
            <div className="tarjeta">
              ...
              <p>
                ...
                instalación con tarjetas de crédito. *Aplican TyC
              </p>
            ...
            <div className="tarjeta">
              ...
              <p>
                Pagos Inmediatos facilitan transacciones diarias, envíos y pagos
                a comercios.
              </p>
        ...
        <section className="productos">
          ...
          <div className="productos-grid">
            <div className="producto">
              ...
              <p>
                Oportunidades para tus proyectos o ideas que necesitan apoyo
                financiero.
              </p>
